export const Home = () => {
  return (
    <>
      <div className='flex flex-col md:flex-row container mx-auto px-8 md:pt-32'>
        <div className='md:basis-1/3 md:pt-20 md:border-r-2 md:border-dotted md:border-black'>
          <h1 className='m-10 md:m-20 text-center'>About</h1>
        </div>
        <div className='md:basis-2/3 md:w-32'>
